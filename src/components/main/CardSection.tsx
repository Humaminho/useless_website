		...
		<div className="cards-section">
			...
			<div className="cards">
				<div className="card">
					...
					<div className="card-content">
						<div className="card-description">
							A responsive e-commerce website selling fashionable
				...
				<div className="card">
					...
					<div className="card-content">
						<div className="card-description">
							A social media app for sharing photos and connecting
				...
				<div className="card">
					<div className="card-title">Online Learning Platform</div>
					<div className="card-content">
						<div className="card-description">
				...
				<div className="card">
					...
					<div className="card-content">
						<div className="card-description">
							A fitness tracking app allowing users to log their
